...
<?php
	...
	echo "<th scope='col' width=120><center><font color=#eb6421>Order</th>";
	echo "<th scope='col'><center>Referentie</th>";
	echo "<th scope='col' width=100>Datum</th>";
	echo "<th scope='col' width=80>Totaal</th>";
	echo "<th scope='col' width=80><font color=tomato>Geleverd</th>";
	echo "<th scope='col' width=80><font color=green>Afroepbaar</th>";
	echo "<th scope='col'><center>Toestel</th>";
	echo "<th scope='col' width=30><center>ETA</th>";
	echo "</tr><tbody>";
	createTable2($stmt);
	echo "</tbody></table>";
