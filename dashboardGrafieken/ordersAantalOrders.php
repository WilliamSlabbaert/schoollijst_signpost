<div style="width:50%;height:100%;">
	<p style="padding-top:45px;">Aantal Orders</p>
	<div id="ordersAantalOrders" class="grafiek-transparant"></div>
</div>

<?php
    // query
    $sql = "SELECT status, count(*) as aantal FROM `byod-orders`.orders where status != 'uitgeleverd' group by status";
    ...
    // maak grafiek
    echo createGrafiek($aantallen, 'Aantal orders', $typeBar, 'ordersAantalOrders');
?>
